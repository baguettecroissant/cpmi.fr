...
export const metadata: Metadata = {
    title: "Annuaire des Professionnels par Département | CPMI.fr",
    description: "Parcourez notre annuaire national pour trouver un installateur certifié d'ascenseur, climatisation ou borne de recharge dans votre département.",
    alternates: {
        canonical: 'https://www.cpmi.fr/annuaire',
    },
};
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="bg-slate-50 border-b border-slate-200 py-16">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
                        Annuaire National des Professionnels
                    </h1>
                    <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                        Sélectionnez votre région ou votre département pour découvrir les professionnels qualifiés
                        en ascenseurs, climatisation et bornes de recharge près de chez vous.
                    </p>
                </div>
            </section>
            ...
            <section className="bg-slate-50 py-16 border-t border-slate-200">
                <div className="container mx-auto px-4 max-w-4xl prose prose-slate">
                    ...
                    <p>
                        L&apos;installation d&apos;un ascenseur ERP, d&apos;une climatisation tertiaire ou d&apos;une borne de recharge IRVE requiert une expertise locale.
                        Les contraintes réglementaires et techniques varient selon les départements et les types de bâtiments.
                    </p>
                    <p>
                        Notre annuaire référence les professionnels certifiés capables d&apos;intervenir rapidement chez vous pour :
                    </p>
                    <ul>
                        <li>Effectuer une étude technique gratuite sur site.</li>
                        <li>Établir un devis détaillé et sans engagement.</li>
                        <li>Vous accompagner dans les démarches de mise en conformité et de financement.</li>
                    </ul>
                </div>
            </section>
        </div>
