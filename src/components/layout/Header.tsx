...
import { FileText, Menu, X, MapPin, Zap } from "lucide-react";
...
export function Header() {
    ...
    const navLinks = [
        ...
        { href: "/installation-ascenseur", label: "Ascenseurs", icon: Zap },
        { href: "/climatisation-entreprise", label: "Climatisation", icon: Zap },
        { href: "/borne-de-recharge-pro", label: "Bornes IRVE", icon: Zap },
    ];
            ...
            <div className="container mx-auto flex h-16 md:h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <Link href="/" className="flex items-center gap-2">
                    <span className="text-xl md:text-2xl font-bold text-slate-900 tracking-tight">
                        CPMI<span className="text-blue-600">.fr</span>
                    </span>
                </Link>
                ...
                <div className="flex items-center gap-4">
                    <Link href="/devis" className="hidden sm:block">
                        <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white text-sm md:text-lg px-4 md:px-8 h-10 md:h-12 shadow-md hover:shadow-lg transition-all rounded-full">
                    ...
                    <nav className="container mx-auto px-4 py-4 space-y-2">
                        ...
                        <div className="pt-4 border-t border-slate-100">
                            <Link href="/devis" onClick={() => setMobileMenuOpen(false)}>
                                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white h-12 rounded-full">
